...
public class Day54 { //di day 54 saya menngcommit codingan tentang LinkedList dengan menambahkan perintah add( ), add(index, element), addFirst( ), addLast( )
